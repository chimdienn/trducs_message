...
app.post("/submit", (req, res) => {
  ...
  count++;
  if (count === 1){
    name = "khánh linh, anh thương em ";
  } else if (count === 20) {
    name = "khánh linh, em chưa mệt hả?";
  } else if (count === 21) {
    name = "anh thì chưa";
  } else if (count === 22) {
    name = "vì trọng đức thương em nhiều vô kể";
  } else if (count > 1 && count < 20)  {
    name = "khánh linh, anh thương em x" + count;
  } else  {
    var newCount = count - 3;
    name = "khánh linh, anh thương em x" + newCount;
  }
  

  res.render("index.ejs", {bandName : name, currentYear: year});
});
